...
INSERT INTO "new_Workflow" ("createdAt", "definition", "description", "id", "lastRunAt", "name", "status", "updatedAt", "userId") SELECT "createdAt", "definition", "description", "id", "lastRunAt", "name", "status", "updatedAt", "userId" FROM "Workflow";
DROP TABLE "Workflow";
