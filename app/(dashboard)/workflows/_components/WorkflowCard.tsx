...
function WorkflowCard({ workflow }: { workflow: Workflow }) {
  ...
  return (
    <Card className='border border-separate shadow-xs transition-shadow rounded-lg overflow-hidden hover:shadow-md dark:shadow-primary/30'>
      <CardContent className='p-4 flex justify-between items-center h-[100px]'>
        <div className='flex items-center justify-end space-x-3'>
          <div className={cn(
            "size-10 rounded-full items-center flex justify-center", 
